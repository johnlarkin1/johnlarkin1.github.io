...
This is going to grab a list of dictionaries of the top 100 cryptos organized by marketcap. This is the default. If you actually pass in `market.ticker(limit=0)` then you grab _all_ of the cryptos that are listed on coinmarketcap (_hint: this is too much_). You can also pass in a currency if you want to observe the stats in a different currency.
