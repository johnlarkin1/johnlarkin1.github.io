...
This is a formulation by [A.-M. Legendre][legendre], a french mathematician. _If you get one thing out of this blog post, **please** let it be clicking on that link and checking out the caricature of A-M Legendre_. It is beyond wild.
...
**THEOREM 1:** _If $$m$$ is a positive integer not of the form $$4^n (8n+7)$$, then $$m$$ is the sum of three squares._
...
_Note: The differences on the time will be explained below_.
