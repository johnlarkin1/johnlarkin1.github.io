...
### 1. Motion Update
*Note, the particle filter **samples** the motion model.*
...
*Note, the particle filter **evaluates** the measurement model.*
...
Then! We **resample**! We assemble $$ P = \{ x_1, x_2, ..., x_{n-1}, x_n \} $$ by sampling with replacement each $$ x_i $$ from $$ P' $$ with probability $$ w_i $$. 
